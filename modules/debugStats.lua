...
function debug.draw()
    if debug.drawStats then
        ...
        love.graphics.print(string.format("MouseMoving? : %s", mouse.Moving), 10, 110)
        love.graphics.print(string.format("M1 IsDown = %s, State = %s", mouse.m1.IsDown, mouse.m1.State), 10, 125)
        love.graphics.print(string.format("M2 IsDown = %s, State = %s", mouse.m2.IsDown, mouse.m2.State), 10, 140)
        love.graphics.print(string.format("M3 IsDown = %s, State = %s", mouse.m3.IsDown, mouse.m3.State), 10, 155)
